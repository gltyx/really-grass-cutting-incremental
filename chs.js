...
var cnItems = {
    ...
    "??? Stars": "??? 星星",
    "Astral": "星界",
    "Automatically update best anonymity/liquefy with current values if they are higher (while decelerated).\n            ": "如果当前值较高（减速时），则使用当前值自动更新最佳匿名/液化。\n",
    ...
    "Keep challenges on Grasshop, Galactic.": "继续挑战Grasshop，Galactic。",
    "Moonstone Upgrades": "月光石升级",
    "more moonstones per 2 grass-skips (starting at 8).": "每 2 个草跳跃（从 8 个开始）有更多的月光石。",
    "more platinum and SP. Active sixth 7 grasshop milestones if you haven't reached them.\n            ": "更多的铂金和SP。如果您还没有达到它们，则激活第六个 7 个草场里程碑。\n",
    ...
    "Unlock Funify reset and The Funny Upgrade rocket fuel upgrade.\n            ": "解锁 Funify 重置和有趣的升级火箭燃料升级。\n",
